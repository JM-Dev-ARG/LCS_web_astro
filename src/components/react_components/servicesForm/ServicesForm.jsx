    ...
    useEffect(() => {
        switch (path.split("/")[2]) {
            ...
            case "retiroForm":
                setSheetName("Retiro");
                break;
            case "independenciaForm":
                setSheetName("Independencia");
                break;
            case "emprendedorForm":
                setSheetName("Emprendedor");
                break;
            case "artForm":
                setSheetName("ART");
                break;
            case "asistenciaForm":
                setSheetName("Asistencia");
                break;
            case "automotoresForm":
                setSheetName("Automotores");
                break;
            case "comercioForm":
                setSheetName("Comercio");
                break;
            case "consorcioForm":
                setSheetName("Consorcio");
                break;
            case "hogarForm":
                setSheetName("Hogar");
                break;
            case "motocicletaForm":
                setSheetName("Motocicleta");
                break;
            case "movilForm":
                setSheetName("Movil");
                break;
    ...
    return (
        <div className="w-full h-full">
            <form
                ...
                <input type="text" name="Fecha" defaultValue={date} hidden={true} />
